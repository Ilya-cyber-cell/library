  ...
  <body>
    ...
    <div class="main-table">
        <table class="reportTable">
            <tr class="reportTable"><th class="reportTable">Номер</th><th class="reportTable">Выдана</th><th class="reportTable">Название</th><th class="reportTable">Срок</th><th class="reportTable">Состаяние</th></tr>
